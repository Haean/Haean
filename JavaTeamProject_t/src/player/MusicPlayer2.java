...
public class MusicPlayer2 extends JFrame {
...
//      play.add(barButton);
	...
	void main_Btn() { // 메인 재생관련 버튼 함수 생성
		...
		repetition.addActionListener(new MyActionListener2());
		play.add(repetition);
	...
	class MyActionListener2 implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			/*
			 * if(btn_state == F_STATE_ICON) {
			 * //System.out.println("btn.getIcon().equals(repetition)"); btn.setIcon(new
			 * ImageIcon("image/1qksqhr.png")); btn_state = N_STATE_ICON; } else {
			 * //System.out.println("#### else not !! btn.getIcon().equals(repetition)");
			 * btn.setIcon(new ImageIcon("image/qksqhr.png")); btn_state = F_STATE_ICON; }
			 */
	}
